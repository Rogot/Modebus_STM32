...
#define MB_USART_RCC_HZ         36000000
...
#define MB_USART_RX_RCC         RCC->AHB1ENR
#define MB_USART_RX_RCC_BIT     RCC_AHB1ENR_GPIOAEN
#define MB_USART_RX_PORT        GPIOA
#define MB_USART_RX_PIN         10
#define MB_USART_RX_ALT_NUM     7

#define MB_USART_TX_RCC         RCC->AHB1ENR
#define MB_USART_TX_RCC_BIT     RCC_AHB1ENR_GPIOAEN
#define MB_USART_TX_PORT        GPIOA
#define MB_USART_TX_PIN         9
#define MB_USART_TX_ALT_NUM     7

#define MB_DMA                  DMA2
#define MB_DMA_RCC              RCC->AHB1ENR
#define MB_DMA_RCC_BIT          RCC_AHB1ENR_DMA2EN
